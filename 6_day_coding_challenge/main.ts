// QUESTION 14:
let guestt :string[]=['masood','Noor','fareed','hira','hashir']
for(let i=0; i<guestt.length; i++){
    console.log('Mr/Miss,'  +guestt[i]+ '\nwe cordially invite you to join a dinner tommorow\n')  
}
let absent_guestt:string='noor'
let new_guestt:string='malahim'
guestt[1]=new_guestt;
...
// QUESTION 16:
let guesttt:string[]=['masood','noor','fareed','hira','hashir']
let absent_guesttt:string='noor'
let new_guesttt:string='malahim'
